...
//    }
    ...
    public void sendEmail() throws MessagingException {
        ...
        List<String> strings=Lists.newArrayList("258401945@qq.com");
//        PageRequest pa=PageRequest.of(0,50);
...
//        content=content.replace("【ZSJL】","汤经理")
//                .replace("【ZSDH】","18612529310");

        String content="good job";
        String[] emalis = strings.toArray(new String[strings.size()]);

        sender.sendEmail(emalis,"2020疫情过后商机，助你盘活经营多年的客户，提升客户价值\n",content);
